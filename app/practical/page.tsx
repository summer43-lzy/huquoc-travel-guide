...
const entrySection = [
  {
    ...
    items: [
      {
        title: '中国公民免签',
        content: '自2023年8月起，越南对中国公民实行30天免签政策（出发前请确认最新政策）。持有效中国护照，无需提前申请签证，直接登机入境。',
        tip: '护照有效期需在出入境日期后至少6个月，请提前确认',
      },
      {
        title: '中国台湾公民签证',
        content: '台湾公民（持中华民国护照）可申请越南电子签证（E-Visa），单次入境最长90天，费用约25美元，在线提交审批通常3个工作日内完成。也可选择落地签（Visa on Arrival），需提前在线申请批准函。',
        tip: '台湾公民建议出发前至少7天在越南移民局官网（evisa.xuatnhapcanh.gov.vn）完成电子签证申请',
      },
      {
        title: '入境须知',
        content: '无需填写入境卡，在海关如实填写健康申报即可。准备好往返机票证明、酒店预订确认单以备查验。全程无需额外签证费。',
