...
const entrySection = [
  {
    ...
    items: [
      ...
      {
        title: '中国香港 / 澳门居民',
        content: '持香港特别行政区护照（HKSAR Passport）可免签入境越南，免签期为14天。持澳门特别行政区护照可免签入境30天。如需更长停留，均可申请越南电子签证（E-Visa），有效期最长90天。',
        tip: '注意：14天免签不含入境当天，如计划停留接近14天请提前规划',
      },
      {
        title: '中国台湾公民 · 需签证',
        content: '持中华民国护照（台湾护照）不在越南免签范围内，需提前申请越南电子签证（E-Visa）。E-Visa可单次或多次入境，最长停留90天，费用约25美元，官网审批一般3个工作日。富国岛曾有"落地30天免签特区"政策，但已于2015年废止，现与全越南签证规则统一。',
        tip: '建议出发前至少7天在越南官方E-Visa网站（evisa.xuatnhapcanh.gov.vn）完成申请并打印电子签证',
      },
      {
        title: '入境须知（所有人）',
        content: '富国岛入境口岸为富国国际机场（PQC），签证规则与越南其他城市完全一致，无特殊豁免。需准备：有效护照、往返机票、酒店预订确认单（偶有查验）。全程在机场办理，无需额外预约。',
...
const otherSections = [
  ...
  },
  {
    ...
    items: [
      {
        title: '本次住宿：希尔顿富国岛',
        content: '坐落于白大湾（Bai Dai）海滩，拥有无边际泳池、私人海滩和多家餐厅。距主城区约20km，提供接送服务。建议要求高层海景房，视野最佳。',
        tip: '提前告知希尔顿是团队出行，可能获得升房或团体服务优惠',
      },
      {
        title: '退房与行李',
