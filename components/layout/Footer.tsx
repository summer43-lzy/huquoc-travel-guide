        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-ocean-200">
              ...
              <li><Link href="/destination" className="hover:text-white transition-colors">目的地介绍</Link></li>
              <li><Link href="/itinerary" className="hover:text-white transition-colors">行程攻略</Link></li>
              <li><Link href="/practical" className="hover:text-white transition-colors">实用信息</Link></li>
            </ul>
          </div>
          <div>
